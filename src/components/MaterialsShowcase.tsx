...
const MATERIALS: MaterialData[] = [
  {
    ...
    btnEn: 'Discover Fidar Bondar Machinery Wood',
    btnFa: 'کشف ماشین‌آلات چوب فیدار بندار',
  ...
  },
  {
    ...
    btnEn: 'Discover Fidar Bondar Machinery Glass',
    btnFa: 'کشف ماشین‌آلات شیشه فیدار بندار',
  ...
  },
  {
    ...
    descFa: 'تکنولوژی برش و پردازش سنگ فیدار بندار، حداکثر انعطاف‌پذیری و دقت فوق‌العاده را برای سنگ‌های طبیعی و مصنوعی فراهم می‌سازد.',
    btnEn: 'Discover Fidar Bondar Machinery Stone',
    btnFa: 'کشف ماشین‌آلات سنگ فیدار بندار',
  ...
  },
  {
    ...
    btnEn: 'Discover Fidar Bondar Materia',
    btnFa: 'کشف متریال‌های پیشرفته فیدار بندار',
      ...
      <div ref={containerRef} className="relative z-30 h-[500vh] bg-black hidden lg:block">
        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          ...
          >
            ...
            <div
              className={`absolute top-0 flex justify-between z-20 select-none flex-col w-[10vw] h-full py-14 ${isFa ? 'right-0' : 'left-0'
                }`}
            >
              {MATERIALS.map((mat, idx) => {
                const isActive = activeIndex === idx;
                return (
                  <button
                    ...
                    className={`flex-1 w-full flex items-center justify-center transition-all duration-300 font-bold cursor-pointer text-slate-900 ${isActive ? 'scale-110 opacity-100 font-extrabold' : 'opacity-60 hover:opacity-100'
                      }`}
                    type="button"
                  >
                    <span
                      className={`inline-block truncate text-lg 3xl:text-xl tracking-wide select-none ${isFa ? 'rotate-90' : 'rotate-[-90deg]'
                        }`}
                    >
                      {isFa ? mat.nameFa : mat.nameEn}
                    </span>
