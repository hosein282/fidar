      ...
      <header className={`sticky top-0 z-[100] w-full bg-surface border-b border-gray-300 shadow-sm transition-transform duration-300 ease-in-out ${headerVisible ? 'translate-y-0' : '-translate-y-full'
          ...
          <div className="max-w-[1440px] mx-auto flex justify-between items-center text-xs font-medium text-slate-800">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="inline-flex border border-black py-0.5 px-3 rounded-full uppercase text-xs font-bold items-center gap-1 cursor-pointer select-none bg-white/80 hover:bg-white text-black transition">
                ...
                <button onClick={() => onLanguageChange('en')} className={`hover:text-primary ${!isFa ? 'text-primary' : ''}`}>
                  ww-en
                </button>
                <span>/</span>
                <button onClick={() => onLanguageChange('fa')} className={`hover:text-primary ${isFa ? 'text-primary' : ''}`}>
                  fa-IR
                </button>
              </div>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-t border-gray-200 px-6 py-6 space-y-4 shadow-xl">
            <div className="inline-flex border left-0 border-black justify-center py-0.5 px-3 rounded-full uppercase text-xs font-bold items-center gap-1 cursor-pointer select-none bg-white/80 hover:bg-white text-black transition">
              <Globe className="w-3.5 h-3.5 text-primary" />
              <button onClick={() => onLanguageChange('en')} className={`hover:text-primary ${!isFa ? 'text-primary' : ''}`}>
                ww-en
              </button>
