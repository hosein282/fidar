    ...
    <footer className="bg-black text-white pt-12 pb-16 px-6 sm:px-12 border-t border-gray-800">
      <div className="max-w-[1440px] mx-auto space-y-12">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-baseline justify-between gap-8 pb-8 border-b border-gray-800">
          ...
          <a href="#" className="shrink-0" aria-label='View Home Page'>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-xs text-slate-400">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed text-slate-400">
              {isFa ? (
                "فیدارسازه بندار یک مجموعه دانش بنیان مهندسی و ساخت تخصصی در حوزه تجهیزات انتقال مواد و ماشین آالت سنگین بندرگاهی است که با تکیه بر دانش مهندسی، تجربه اجرایی و رویکردی مبتنی بر دقت، کیفیت و نوآوری فعالیت میکند."
              ) : (
          ...
          <div>
             <a href={`/${lang}/blog`} aria-label='Show Blogs and News of Fidar Saze Bondar'>  <h4 className="text-white font-bold text-sm mb-3">{isFa ? 'مقالات و اخبار ' : 'Articles & News'}</h4></a>
            <ul className="space-y-2">
        ...
        <div className="flex flex-col xl:flex-row justify-between items-center gap-4 text-[11px] text-slate-500 pt-6 border-t border-gray-800">
          ...
          <div className="flex flex-wrap gap-4 text-slate-400">
            <a href="#" aria-label='Privacy center' className="hover:text-white">Privacy center</a>
            <a href="#" aria-label='cookie policy' className="hover:text-white">Privacy and cookie policy</a>
            <a href="#" aria-label='of cookies' className="hover:text-white">List of cookies</a>
            <a href="#" aria-label='">Whistleblowing' className="hover:text-white">Whistleblowing</a>
            <a href="#" aria-label='Data Act' className="hover:text-white">Data Act</a>
          </div>
        </div>
