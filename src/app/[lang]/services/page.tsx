...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const isEn = lang === 'en';
  const path = isEn ? '/en/services' : '/fa/services';
  ...
  return {
    ...base,
    title: isEn
      ? 'Services — Engineering, Manufacturing & Refurbishment | Fidar Sazeh Bandar'
      : 'خدمات — مهندسی، ساخت و بازسازی تجهیزات | فیدار سازه بندار',
    description: isEn
